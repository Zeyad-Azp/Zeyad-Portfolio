      ...
      <nav className="glass bg-[#08080a]/60 border border-white/[0.04] px-4 py-2.5 rounded-full flex gap-1.5 sm:gap-3 items-center shadow-[0_15px_35px_rgba(0,0,0,0.6)] backdrop-blur-lg">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              {/* Tooltip */}
              <span className="absolute bottom-12 bg-zinc-950 border border-zinc-800 text-[10px] text-zinc-300 font-mono px-2 py-0.5 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none tracking-widest uppercase">
                {item.label}
              </span>
